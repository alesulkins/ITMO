                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="tests/operativ_memory_test.php?user_id=<?php echo $_SESSION['user_id']; ?>">Тест на реакцию на свет</a>
                                ...
                                <a class="dropdown-item" href="tests/visual_memory_test.php?user_id=<?php echo $_SESSION['user_id']; ?>">Совмещённая операторская деятельность</a>
                            </div>
                        </div>
                    </li>
                <?php endif; ?>
                        ...
                        <?php if (strpos($notification['message'], 'назначен тест') !== false): ?>
                            ...
                            switch($test_name) {
                                ...
                                case 'combined_operator':
                                    $test_url = 'tests/visual_memory_test.php';
                                    break;
                            }
