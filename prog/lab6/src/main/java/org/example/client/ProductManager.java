    ...
    public static Product createProduct() {
        ...
        while (unitOfMeasure == null) {
            try {
                ...
                String unitOfMeasureInput = scanner.nextLine().trim().toUpperCase();
                unitOfMeasure = UnitOfMeasure.valueOf(unitOfMeasureInput);
        ...
        if (addOwnerInput.equals("yes")) {
            ...
            while (hairColor == null) {
                try {
                    ...
                    String hairColorInput = scanner.nextLine().toUpperCase().trim();
                    if (hairColorInput.isEmpty()) break;
                    hairColor = Color.valueOf(hairColorInput);
                } catch (IllegalArgumentException e) {
            ...
            while (nationality == null) {
                try {
                    ...
                    String nationalityInput = scanner.nextLine().toUpperCase().trim();
                    nationality = Country.valueOf(nationalityInput);
                } catch (IllegalArgumentException e) {
