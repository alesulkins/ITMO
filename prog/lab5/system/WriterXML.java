...
/**
 * Обеспечивает сериализацию коллекции продуктов в XML-формат.
 * Форматирует даты в соответствии со стандартом ISO 8601.
 */
public class WriterXML {
    /**
     * Записывает коллекцию продуктов в XML-файл.
     *
     * @param path Путь для сохранения файла
     * @param products Коллекция продуктов для записи
     */
    ...
    public static Element createProductElement(Document doc, Product product) {
    ...
    public static Element createOwnerElement(Document doc, Person owner) {
