...
/**
 * Осуществляет чтение и парсинг XML-файлов в коллекцию продуктов.
 * Обрабатывает сложные структуры данных и пропускает некорректные записи.
 */
public class ReaderXML {
    /**
     * Читает XML из входного потока и создает стек продуктов.
     *
     * @param inputStream Поток данных для чтения
     * @return Стек объектов Product
     */
